...
public interface CHStoJCRMigrator {
    ...
    /*
     * Stop/Pause the Migration. Will finish the current batch of
     * files/folders
     */
    public void stopMigrating();
    
    /*
     * Find out if we're currently copying files in the background.
     * 
     * @return Are we currently migrating?
     */
    public boolean isCurrentlyMigrating();
    
    /*
     * This is number of files/folders that are copied before taking
     * a delay break, or checking to see if we stopped/paused the
     * migration.
     */
    ...
    /*
     * Get the amount of time we wait between copying each batch
     * of files. 
     */
    public int getDelayBetweenBatchesMilliSeconds();
    
    /*
     * Set the number of milli seconds to delay between copying
     * each batch of files.
     */
