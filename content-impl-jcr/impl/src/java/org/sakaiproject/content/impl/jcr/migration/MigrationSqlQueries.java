...
public class MigrationSqlQueries {
    ...
    public static final String select_unfinished_items = "SELECT *" 
        + " FROM MIGRATE_CHS_CONTENT_TO_JCR M" 
        + " WHERE STATUS = 0"
        + " LIMIT 0, ?";
    ...
    public static final String add_original_collections_to_migrate = 
    ...
    public static final String add_original_resources_to_migrate = 
        "INSERT INTO MIGRATE_CHS_CONTENT_TO_JCR"
      + " (CONTENT_ID)"
